...
public class BookingManager {
    ...
    public static void terminal_booking() {
        ...
        public static void search(){
            ...
            do { 
                ...
                System.out.println(yeelow("║")+RoomManager.form_option("2. tim kiem theo sdt khach hang", 70)+yeelow("║"));
        ...
        for (Booking book : BookingManager.bookings){
            ...
            for (Map.Entry<LocalDate,TreeMap<Integer,ArrayList<Room>>> c : book.getDate().entrySet()){
                if (date == null){
                    ...
                    str.append("?");str.append(c.getKey().format(f));
                }
   ...
   public static void history(){
    ...
    public static void thongke_total_booking(){
       ...
       System.out.println("╠" + RoomManager.border(15)+"╦"+ RoomManager.border(20)+"╦"+ RoomManager.border(20)+"╦"+ RoomManager.border(20)+"╦"+ RoomManager.border(20)+"╦"+ RoomManager.border(20)+"╣");
       System.out.println("║" + RoomManager.form_SO("Nam",15)+"║"+ RoomManager.form_SO("QUY 1",20)+"║"+ RoomManager.form_SO("QUY 2",20)+"║"+ RoomManager.form_SO("QUY 3",20)+"║"+ RoomManager.form_SO("QUY 4",20)+"║"+ RoomManager.form_SO("TONG TIEN",20)+"║");
       ...
       for (Map.Entry<Integer,Double[]> c1 : c.entrySet() ){
        ...
        System.out.println("║" + RoomManager.form_SO(c1.getKey(),15)+"║"+ RoomManager.form_SO(c1.getValue()[0],20)+"║"+ RoomManager.form_SO(c1.getValue()[1],20)+"║"+ RoomManager.form_SO(c1.getValue()[2],20)+"║"+ RoomManager.form_SO(c1.getValue()[3],20)+"║"+ RoomManager.form_SO(price,20)+"║");
       }
       System.out.println("╚" + RoomManager.border(15)+"╩"+ RoomManager.border(20)+"╩"+ RoomManager.border(20)+"╩"+ RoomManager.border(20)+"╩"+ RoomManager.border(20)+"╩"+ RoomManager.border(20)+"╝");
    }
