...
public class RoomManager {
    ...
    // FileReader("./Quoc_Bao_OOP/data/Roommanager.txt"))){
    // String line ;
    // while((line = br.readLine())!=null){
    // String[] str = line.split("#");
    ...
    public void show_calendar(LocalDate begin, LocalDate end, int size) {
        ...
        for (Map.Entry<LocalDate, ArrayList<Room>> lich : this.calendar.entrySet()) {
            int dem = 0;
            String mau;
            if (lich.getKey().getDayOfMonth() % 2 == 0) {
                mau = "\u001B[33m";
            } else {
                mau = "\u001B[35m";
            }
    ...
    public void history() {
        ...
        if (bansao.isEmpty()) {
            System.out.println("╠" + border(10) + "╩" + border(10) + "╩" + border(15) + "╩" + border(10) + "╩"
                    + border(15) + "╩" + border(25) + "╩" + border(10) + "╩" + border(10) + "╩" + border(20) + "╩"
                    + border(20) + "╣");
            ...
            for (Room room : c.getValue()) {
                ...
                for (int i = 0; i < 3; i++) {
                    if (room.getCalendar().get(c.getKey())[i] != null) {
                        ...
                        str.append("║"
                                + (i == 0 ? form_SO("sang", 10) : i == 1 ? form_SO("trua", 10) : form_SO("chieu", 10)));
    ...
    public void history_by_date(LocalDate begin, LocalDate end) {
        ...
        System.out.println("╠" + border(10) + "╦" + border(10) + "╦" + border(15) + "╦" + border(10) + "╦" + border(15)
                + "╦" + border(25) + "╦" + border(10) + "╦" + border(10) + "╦" + border(20) + "╦" + border(20) + "╣");
        System.out.println("║" + form_SO("BK ID", 10) + "║" + form_SO("PHONG", 10) + "║" + form_SO("NGAY", 15) + "║"
                + form_SO("buoi", 10) + "║" + form_SO("SDT KH", 15) + "║" + form_SO("TEN Khach Hang", 25) + "║"
                + form_SO("ID MNG", 10) + "║" + form_SO("SV_TEAM", 10) + "║" + form_SO("DICH VU", 20) + "║"
                + form_SO("Total price", 20) + "║");
        ...
        for (Map.Entry<LocalDate, ArrayList<Room>> c : bansao.entrySet()) {
            ...
            for (Room room : c.getValue()) {
                ...
                String s = dem == 0 ? ("╠" + border(154) + "╣") : ("║" + border_thuong(154) + "║");
                if (dem == 0) {
                    s = "╠" + border(10) + "╩" + border(10) + "╩" + border(15) + "╩" + border(10) + "╩" + border(15)
                            + "╩" + border(25) + "╩" + border(10) + "╩" + border(10) + "╩" + border(20) + "╩"
                            + border(20) + "╣";
                }
                dem++;
                System.out.println(s);
    ...
    public static void main(String[] args) {
        ...
        // rmng.show_calendar(LocalDate.of(2024, 12, 12), LocalDate.of(2024, 12, 14),
        // 0);
